...
namespace MYCalibrationV2
{
    public partial class Form1 : Form
    {
        ...
        private double[] _glModelView8pts;
        ...
        private void glControl1_Load(object sender, EventArgs e)
        {
            ...
            Size imageSize;
            _backgroundTextureId = TexUtil.CreateTextureFromFile("../../../photos/photo_19-5-2016_10-21-30-422.jpg", out imageSize);
        ...
        private void glControl1_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (_isCalibrated)
                ...
                GL.MultMatrix(_glProjectionMatrix);
        ...
        private void glDrawScene()
        {
            ...
            GL.Begin(BeginMode.Points);
            GL.Vertex3(_listObjectPoints.ElementAt(0));
            GL.End();
            GL.Color3(1.0f, 1.0f, 1.0f);

            GL.Color3(0.0f, 1.0f, 0.0f);
            GL.Begin(BeginMode.Points);
            GL.Vertex3(_listObjectPoints.ElementAt(1));
            GL.End();
            GL.Color3(1.0f, 1.0f, 1.0f);

            GL.Color3(1.0f, 1.0f, 0.0f);
            GL.Begin(BeginMode.Points);
            GL.Vertex3(_listObjectPoints.ElementAt(2));
            GL.End();
            GL.Color3(1.0f, 1.0f, 1.0f);
        ...
        private void DrawQuad()
        {
            ...
            GL.Vertex3(_listObjectPoints.ElementAt(1));
            GL.Vertex3(_listObjectPoints.ElementAt(2));
            GL.Vertex3(_listObjectPoints.ElementAt(3));

            /*GL.Vertex3(0, 0, 0);
            GL.Vertex3(0, 148f, 0);
            GL.Vertex3(210f, 148f, 0);
            GL.Vertex3(210f, 0f, 0);*/
        ...
        private void LookAt()
        {
            ...
            if (_isCalibrated)
            {
                ...
                //GL.MatrixMode(MatrixMode.Modelview);
                //GL.LoadMatrix(_glModelView8pts);
        ...
        /// <summary>
        /// Recupère les paramètres de la camera à partir du document xml de la calibration
        /// </summary>
        private void GetCamParams()
        {
            ...
            ///////
            _camIntParams = new double[3, 3] { { _fx,      0,      glControl1.Width/2.0},
                                               {   0,    _fy,     glControl1.Height/2.0},
                                               {   0,      0,                   1} };
        ...
        {
            _listImagePoints.Add(new Vector2(392.296f,  221.876f));
            _listImagePoints.Add(new Vector2(634.203f,  189.495f));
            _listImagePoints.Add(new Vector2(681.638f,  287.72f));
            _listImagePoints.Add(new Vector2(412.448f,  327.44f));
        }
