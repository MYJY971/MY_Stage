...
{
    public struct Mat4 //code Matrix4 de OpenTK
    {
        #region Fields
        ...
        /// The identity matrix
        /// </summary>
        public static Mat4 Identity = new Mat4(Vect4D.UnitX, Vect4D.UnitY, Vect4D.UnitZ, Vect4D.UnitW);
        ...
        public Mat4(Vect4D row0, Vect4D row1, Vect4D row2, Vect4D row3)
        {
            Row0 = row0;
            Row1 = row1;
            Row2 = row2;
        ...
        {
            Row0 = new Vect4D(m00, m01, m02, m03);
            Row1 = new Vect4D(m10, m11, m12, m13);
            Row2 = new Vect4D(m20, m21, m22, m23);
            Row3 = new Vect4D(m30, m31, m32, m33);
        }
        ...
        /// </summary>
        public Vect4D Column0
        {
            get { return new Vect4D(Row0.X, Row1.X, Row2.X, Row3.X); }
        }

        /// <summary>
        /// The second column of this matrix
        /// </summary>
        public Vect4D Column1
        {
            get { return new Vect4D(Row0.Y, Row1.Y, Row2.Y, Row3.Y); }
        }

        /// <summary>
        /// The third column of this matrix
        /// </summary>
        public Vect4D Column2
        {
            get { return new Vect4D(Row0.Z, Row1.Z, Row2.Z, Row3.Z); }
        }

        /// <summary>
        /// The fourth column of this matrix
        /// </summary>
        public Vect4D Column3
        {
            get { return new Vect4D(Row0.W, Row1.W, Row2.W, Row3.W); }
        }
        ...
        public static void Mult(ref Mat4 left, ref Mat4 right, out Mat4 result)
        {
        ...
        public void Invert(ref Mat4 result)
        {
        ...
        void InvertAffine(ref Mat4 result)
        {
            float m11 = Row0.X, m12 = Row0.Y, m13 = Row0.Z, m14 = Row0.W,
            m21 = Row1.X, m22 = Row1.Y, m23 = Row1.Z, m24 = Row1.W,
            m31 = Row2.X, m32 = Row2.Y, m33 = Row2.Z, m34 = Row2.W;
        ...
        public static void Transpose(ref Mat4 mat, out Mat4 result)
        {
            //result = new Mat4();
        ...
        {
            result = Identity;
            result.Row3 = new Vect4D(x, y, z, 1);
        }
        ...
        /// <param name="result">The resulting Matrix4 instance.</param>
        public static void CreateTranslation(ref Vect3D vector, out Mat4 result)
        {
            result = Identity;
            result.Row3 = new Vect4D((float)vector.X, (float)vector.Y, (float)vector.Z, 1);
        }
        ...
        /// <param name="vector">The translation vector.</param>
        /// <returns>The resulting Matrix4 instance.</returns>
        public static Mat4 CreateTranslation(Vect3D vector)
        {
            Mat4 result;
            CreateTranslation((float)vector.X, (float)vector.Y, (float)vector.Z, out result);
            return result;
        }
        ...
        public static Mat4 LookAt(Vect3D eye, Vect3D target, Vect3D up)
        {
            Vect3D z = Vect3D.Normalize(eye - target);
            Vect3D x = Vect3D.Normalize(Vect3D.Cross(up, z));
            Vect3D y = Vect3D.Normalize(Vect3D.Cross(z, x));

            Mat4 rot = new Mat4(new Vect4D((float)x.X, (float)y.X, (float)z.X, 0.0f),
                                        new Vect4D((float)x.Y, (float)y.Y, (float)z.Y, 0.0f),
                                        new Vect4D((float)x.Z, (float)y.Z, (float)z.Z, 0.0f),
                                        Vect4D.UnitW);

            Mat4 trans = Mat4.CreateTranslation(-eye);
