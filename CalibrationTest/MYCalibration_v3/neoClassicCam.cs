...
namespace MYCalibration_v3
{
    public class neoClassicCam
    {
        ...
        public neoClassicCam(int width, int height)
        {
            this._width = width;
            this._height = height;
            _eye = Vector3.Zero;
        ...
        public neoClassicCam(int width, int height, Vector3 eye, Vector3 target, Vector3 up)
        {
            this._eye = eye;
            this._target = target;
            this._up = up;
        ...
        #region Projection
        public void SetDefaultProjection(float width, float height)
        {
