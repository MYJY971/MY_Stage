...
namespace MYTestOpenGlv3
{
    public class MatrixCSML
    {
        ...
        public MatrixCSML(Complex[,] values)
        {
            if (values == null)
            {
                Values = new ArrayList();
        ...
        /// </summary>
        /// <param name="values"></param>
        public MatrixCSML(double[,] values)
        {
            if (values == null)
            {
                Values = new ArrayList();
        ...
        /// <summary>
        /// Creates matrix from 2-f double array.
        /// </summary>
        /// <param name="values"></param>
        public MatrixCSML(float[,] values)
        {
            if (values == null)
            {
                Values = new ArrayList();
        ...
        /// </summary>
        /// <returns></returns>
        public Matrix ConvertMYMatrix()
        {
            string s = "";
            Complex buf;

            float[,] val = new float[rowCount, columnCount];
        ...
        public MatrixCSML(string matrix_string)
        {
            // remove spaces
        ...
        /// <returns></returns>
        public static MatrixCSML E(int n, int j)
        {
            MatrixCSML e = Zeros(n, 1);
            e[j] = Complex.One;
        ...
        /// <returns></returns>
        public static MatrixCSML ChessboardMatrix(int m, int n, bool even)
        {
            MatrixCSML M = new MatrixCSML(m, n);
        ...
        /// <param name="even">Indicates, if matrix entry (1,1) equals zero.</param>
        /// <returns></returns>
        public static MatrixCSML ChessboardMatrix(int n, bool even)
        {
            MatrixCSML M = new MatrixCSML(n);
        ...
        public static MatrixCSML Zeros(int m, int n)
        {
            return new MatrixCSML(m, n);
        }
        ...
        public static MatrixCSML Zeros(int n)
        {
            return new MatrixCSML(n);
        }
        ...
        public static MatrixCSML Ones(int m, int n)
        {
            MatrixCSML M = new MatrixCSML(m, n);
        ...
        public static MatrixCSML Ones(int n)
        {
            MatrixCSML M = new MatrixCSML(n);
        ...
        public static MatrixCSML Identity(int n)
        {
        ...
        /// <param name="n">Number of rows and columns, resp.</param>
        /// <returns></returns>
        public static MatrixCSML Eye(int n)
        {
            return Identity(n);
        }
        ...
        public static MatrixCSML VerticalConcat(MatrixCSML A, MatrixCSML B)
        {

            MatrixCSML C = A.Column(1);
        ...
        public static MatrixCSML VerticalConcat(MatrixCSML[] A)
        {
            if (A == null)
            ...
            {
                MatrixCSML C = VerticalConcat(A[0], A[1]);
        ...
        public static MatrixCSML HorizontalConcat(MatrixCSML A, MatrixCSML B)
        {
            MatrixCSML C = A.Row(1);
        ...
        public static MatrixCSML HorizontalConcat(MatrixCSML[] A)
        {
            if (A == null)
                throw new ArgumentNullException();
            else if (A.Length == 1)
            ...
            {
                MatrixCSML C = HorizontalConcat(A[0], A[1]);
        ...
        /// <returns></returns>
        public static MatrixCSML Diag(MatrixCSML diag_vector)
        {
            ...
            MatrixCSML M = new MatrixCSML(dim, dim);
        ...
        /// <param name="diag_vector">column vector containing the diag elements</param>
        /// <returns></returns>
        public static MatrixCSML Diag(MatrixCSML diag_vector, int offset)
        {
            int dim = diag_vector.VectorLength();
            ...
            MatrixCSML M = new MatrixCSML(dim + Math.Abs(offset), dim + Math.Abs(offset));
            dim = M.RowCount;
        ...
        public static MatrixCSML TriDiag(Complex l, Complex d, Complex u, int n)
        {
            if (n <= 1)
        ...
        /// <returns></returns>
        public static MatrixCSML TriDiag(MatrixCSML l, MatrixCSML d, MatrixCSML u)
        {
        ...
        public static Complex Dot(MatrixCSML v, MatrixCSML w)
        {
        ...
        /// <param name="n"></param>
        /// <returns></returns>
        public static MatrixCSML RandomGraph(int n)
        {
            MatrixCSML buf = Random(n, n);
        ...
        /// <returns></returns>
        public static MatrixCSML RandomGraph(int n, double p)
        {
            MatrixCSML buf = new MatrixCSML(n);
        ...
        /// <param name="n"></param>
        /// <returns></returns>
        public static MatrixCSML Random(int m, int n)
        {
            MatrixCSML M = new MatrixCSML(m, n);
            Random r = new Random();
        ...
        /// <param name="n"></param>
        /// <returns></returns>
        public static MatrixCSML Random(int n)
        {
            MatrixCSML M = new MatrixCSML(n);
            Random r = new Random();
        ...
        /// <returns></returns>
        public static MatrixCSML Random(int n, int lo, int hi)
        {
            MatrixCSML M = new MatrixCSML(n);
            Random r = new Random();
        ...
        /// <returns></returns>
        public static MatrixCSML RandomZeroOne(int m, int n, double p)
        {
            MatrixCSML M = new MatrixCSML(m, n);
            Random r = new Random();
        ...
        /// <param name="p">Probability fro an entry to be one, expecting a value in [0,1].</param>
        /// <returns></returns>
        public static MatrixCSML RandomZeroOne(int n, double p)
        {
            MatrixCSML M = new MatrixCSML(n, n);
            Random r = new Random();
        ...
        /// <param name="n">Number of columns.</param>
        /// <returns></returns>
        public static MatrixCSML Random(int m, int n, int lo, int hi)
        {
            MatrixCSML M = new MatrixCSML(m, n);
            Random r = new Random();
        ...
        public static MatrixCSML Vandermonde(Complex[] x)
        {
            ...
            MatrixCSML V = new MatrixCSML(n + 1);
        ...
        /// u to v.</returns>
        public static MatrixCSML[] Floyd(MatrixCSML adjacence_matrix)
        {
            ...
            MatrixCSML D = adjacence_matrix.Clone(); // distance matrix
            MatrixCSML P = new MatrixCSML(n);
        ...
        /// <returns></returns>
        public static ArrayList FloydPath(MatrixCSML P, int i, int j)
        {
            if (!P.IsSquare())
        ...
        public static MatrixCSML DFS(MatrixCSML adjacence_matrix, int root)
        {
            if (!adjacence_matrix.IsSquare())
            ...
            MatrixCSML spanTree = new MatrixCSML(n);
        ...
        /// <param name="root">The vertex to begin the search.</param>
        /// <returns>Adjacence matrix of the computed spanning tree.</returns>
        public static MatrixCSML BFS(MatrixCSML adjacence_matrix, int root)
        {
            if (!adjacence_matrix.IsSquare())
                throw new ArgumentException("Adjacence matrices are expected to be square.");
            else if (!adjacence_matrix.IsReal())
        ...
        /// <returns></returns>
        public static MatrixCSML ZeroOneRandom(int m, int n, double p)
        {
            Random r = new Random();

            MatrixCSML buf = Zeros(m, n);
        ...
        /// <param name="p">Probability of each entry being 1.</param>
        /// <returns></returns>
        public static MatrixCSML ZeroOneRandom(int n, double p)
        {
            Random r = new Random();

            MatrixCSML buf = Zeros(n);
        ...
        /// <param name="x"></param>
        /// <returns></returns>
        private static MatrixCSML[] HouseholderVector(MatrixCSML x)
        {
            ...
            MatrixCSML y = x / x.Norm();
            MatrixCSML buf = y.Extract(2, n, 1, 1);
            Complex s = Dot(buf, buf);

            MatrixCSML v = Zeros(n, 1);
            v[1] = Complex.One;
            ...
            return new MatrixCSML[] { v, new MatrixCSML(beta) };
        ...
        /// <returns></returns>
        public static MatrixCSML BlockMatrix(MatrixCSML A, MatrixCSML B, MatrixCSML C, MatrixCSML D)
        {
            ...
            MatrixCSML R = new MatrixCSML(A.RowCount + C.RowCount, A.ColumnCount + B.ColumnCount);
        ...
        public static MatrixCSML Solve(MatrixCSML A, MatrixCSML b)
        {
            MatrixCSML A2 = A.Clone();
            MatrixCSML b2 = b.Clone();
        ...
        /// </summary>
        /// <returns></returns>
        public MatrixCSML Re()
        {
            MatrixCSML M = new MatrixCSML(rowCount, columnCount);
        ...
        /// </summary>
        /// <returns></returns>
        public MatrixCSML[] HessenbergHouseholder()
        {
            ...
            int n = rowCount;
            MatrixCSML Q = Identity(n);
            MatrixCSML H = this.Clone();
            MatrixCSML I, N, R, P;
            MatrixCSML[] vbeta = new MatrixCSML[2];
            int m;
        ...
        /// </summary>
        /// <returns></returns>
        public MatrixCSML ExtractLowerTrapeze()
        {
            MatrixCSML buf = new MatrixCSML(rowCount, columnCount);
        ...
        /// </summary>
        /// <returns></returns>
        public MatrixCSML ExtractUpperTrapeze()
        {
            MatrixCSML buf = new MatrixCSML(rowCount, columnCount);
        ...
        public MatrixCSML[] ColumnVectorize()
        {
            MatrixCSML[] buf = new MatrixCSML[columnCount];
        ...
        public MatrixCSML[] RowVectorize()
        {
            MatrixCSML[] buf = new MatrixCSML[rowCount];
        ...
        public MatrixCSML ExtractRow(int i)
        {
            MatrixCSML buf = this.Row(i);
            this.DeleteRow(i);
        ...
        /// <returns>Row vector.</returns>
        public MatrixCSML ExtractColumn(int j)
        {
            if (j <= 0 || j > columnCount)
                throw new ArgumentException("Index must be positive and <= number of cols.");

            MatrixCSML buf = this.Column(j);
            this.DeleteColumn(j);
        ...
        public void InsertRow(MatrixCSML row, int i)
        {
        ...
        public void Insert(int i, int j, MatrixCSML M)
        {
        ...
        public void InsertColumn(MatrixCSML col, int j)
        {
        ...
        public MatrixCSML Inverse()
        {
            ...
            if (n == 1) return new MatrixCSML(1 / det);
        ...
        /// </summary>
        /// <returns>Inverse of matrix.</returns>
        public MatrixCSML InverseLeverrier()
        {
            if (!this.IsSquare())
                throw new InvalidOperationException("Cannot invert non-square matrix.");
            ...
            int n = this.rowCount;
            MatrixCSML Id = Identity(n);
            MatrixCSML B = Id;
            Complex alpha;

            for (int k = 1; k < n; k++)
            {
                MatrixCSML buf = (this * B); // DEBUG                
                Complex buf2 = buf.Trace(); // DEBUG
                alpha = ((double)1 / k) * buf.Trace();
                B = alpha * Id - buf;
            }

            MatrixCSML buf3 = (this * B); // DEBUG                
        ...
        /// <returns></returns>
        public MatrixCSML Minor(int i, int j)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public MatrixCSML Clone()
        {
            MatrixCSML A = new MatrixCSML();
            A.rowCount = rowCount;
        ...
        public MatrixCSML Column(int j)
        {
            MatrixCSML buf = new MatrixCSML(this.rowCount, 1);
        ...
        public MatrixCSML Row(int i)
        {
            ...
            MatrixCSML buf = new MatrixCSML(columnCount, 1);
        ...
        public MatrixCSML Transpose()
        {
            MatrixCSML M = new MatrixCSML(columnCount, rowCount);
        ...
        /// </summary>
        /// <returns></returns>
        public MatrixCSML ConjTranspose()
        {
        ...
        public MatrixCSML LUSafe()
        {
            ...
            MatrixCSML P = Identity(n); // permutation matrix
            int m;
        ...
        public void ForwardInsertion(MatrixCSML b)
        {
        ...
        /// </summary>
        /// <param name="b">Vector of height n, if matrix is n by n.</param>
        public void BackwardInsertion(MatrixCSML b)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public MatrixCSML[] QRGramSchmidt()
        {
            int m = rowCount;
            int n = columnCount;
            ...
            MatrixCSML Q = new MatrixCSML(m, n);
            MatrixCSML R = new MatrixCSML(n, n);
        ...
        /// <returns></returns>
        public MatrixCSML Eigenvector(Complex eigenvalue)
        {
        ...
        /// <param name="b"></param>
        /// <returns></returns>
        public MatrixCSML SolveCG(MatrixCSML b)
        {
            throw new NotImplementedException("Still buggy!");
            ...
            MatrixCSML x = Ones(n, 1); // x will contain the solution
            MatrixCSML r = b - this * x; // residual approaches zero as x converges to the solution
            MatrixCSML d = r; // dir = direction of descence
            double delta = r.Norm(); // delta denotes the current error
            delta *= delta;
            tolerance *= tolerance;

            MatrixCSML h = Zeros(n, 1);
            double alpha, gamma;
            double old_delta;
        ...
        /// <returns></returns>
        public MatrixCSML QRIterationBasic(int max_iterations)
        {
            if (!this.IsReal())
                throw new InvalidOperationException("Basic QR iteration is possible only for real matrices.");

            MatrixCSML T = this.Clone();
            MatrixCSML[] QR = new MatrixCSML[2];
        ...
        /// <param name="max_iterations"></param>
        /// <returns></returns>
        public MatrixCSML QRIterationHessenberg(int max_iterations)
        {
            ...
            MatrixCSML[] TQ = this.HessenbergHouseholder();
            MatrixCSML T = TQ[0];

            for (int j = 1; j <= max_iterations; j++)
            {
                MatrixCSML[] QRcs = T.QRGivens();
                T = QRcs[1];
        ...
        public MatrixCSML[] QRGivens()
        {
            ...
            MatrixCSML c = Zeros(n - 1, 1);
            MatrixCSML s = Zeros(n - 1, 1);
            Complex[] cs;
            ...
            return new MatrixCSML[] { GivProd(c, s, n), H, c, s };
        }
        ...
        /// <param name="n"></param>
        /// <returns></returns>
        private MatrixCSML GivProd(MatrixCSML c, MatrixCSML s, int n)
        {
            int n1 = n - 1;
            int n2 = n - 2;
            ...
            for (int k = n2; k >= 1; k--)
            {
                ...
                Q[k, k] = c[k];
                Q[k1, k] = -s[k];
                MatrixCSML q = Q.Extract(k1, k1, k1, n);
                Q.Insert(k, k1, s[k] * q);
        ...
        public DefinitenessType Definiteness()
        {
            ...
            MatrixCSML[] y = new MatrixCSML[n + 1];
            for (int i = 0; i <= n; i++)
                y[i] = MatrixCSML.Zeros(n, 1);

            y[1] = this.Column(1);

            MatrixCSML xk; // to buffer this.Column(k)
            MatrixCSML buf;
        ...
        public static bool operator ==(MatrixCSML A, MatrixCSML B)
        {
        ...
        public static MatrixCSML operator +(MatrixCSML A, MatrixCSML B)
        {
        ...
        public static MatrixCSML operator -(MatrixCSML A)
        {
        ...
        public static MatrixCSML operator *(MatrixCSML A, MatrixCSML B)
        {
            ...
            MatrixCSML C = new MatrixCSML(A.RowCount, B.ColumnCount);
        ...
        public static MatrixCSML operator *(MatrixCSML A, Complex x)
        {

            MatrixCSML B = new MatrixCSML(A.rowCount, A.columnCount);
        ...
        public static MatrixCSML operator *(Complex x, MatrixCSML A)
        {
        ...
        public static MatrixCSML operator *(MatrixCSML A, double x)
        {
            return (new Complex(x)) * A;
        }

        public static MatrixCSML operator *(double x, MatrixCSML A)
        {
            return (new Complex(x)) * A;
        }
        ...
        public static MatrixCSML operator ^(MatrixCSML A, int k)
        {
            if (k < 0)
                if (A.IsSquare())
                ...
                if (A.IsSquare())
                    return MatrixCSML.Identity(A.RowCount);
                else throw new InvalidOperationException("Cannot take non-square matrix to the power of zero.");
            else if (k == 1)
                if (A.IsSquare())
                    return A;
