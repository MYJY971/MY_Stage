...
namespace MYTestOpenGlv3
{
    public partial class Form1 : Form
    {
        ...
        private float _north = 0;
        private double _angleCompass = 0;

        private bool _activate_OrientationSensor = false;
        private bool _activate_Compass = false;

        static double _angleH = 1; //Math.PI / 2;
        static double _angleV = 1;
        ...
        RotationMatrix _matCompass = new RotationMatrix(2, 0);
        ...
        Vector _eye0 = new Vector(15, 0, 0);
        ...
        public Form1()
        {
            ...
            if (_sensor != null && _activate_OrientationSensor==true)
            {
        ...
        {
            //_angleCompass = args.Reading.HeadingMagneticNorth;

            _angleCompass = Math.PI * - args.Reading.HeadingMagneticNorth / 180.0;
            _matCompass.Update(_angleCompass);
            ...
            textBoxCompass.Text = "" + args.Reading.HeadingMagneticNorth;
        }
